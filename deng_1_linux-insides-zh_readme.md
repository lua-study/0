...
|├ [6.4](https://github.com/MintCN/linux-insides-zh/blob/master/SyncPrim/linux-sync-4.md)||未开始|
...
* 最后，将 [README.md](https://github.com/MintCN/linux-insides-zh/blob/master/README.md) 中的翻译状态修改为“更新至上游 commit id”(**注：8 位 commit id**)，同时不要忘记把自己添加到 [CONTRIBUTORS.md](https://github.com/MintCN/linux-insides-zh/blob/master/CONTRIBUTORS.md) 中。
