...
public class UserRepositoryIntegrationTests {
    ...
    public void sampleTestCase() {
        ...
        List  result10 = repository.findByLastNameNamedOql("Yuan");
    ...
    public void testFindByMethodName() {
        List  result1 = repository.findAllByEmailAddressAndFullNameLastName("yuanxuegui@163.com", "Yuan");
        assertEquals(1, result1.size());
        assertEquals("Yuan", result1.get(0).getFullName().getLastName());
        assertThat(result1, hasItem(user));
    }
...
public class EbeanQueryChannelServiceIntegrationTests {
    ...
    public void createSqlQueryMappingColumns() {
        ...
        Query  query1 = ebeanQueryChannelService.createSqlQuery(UserInfo.class,
                sql1);
        Query  query2 = ebeanQueryChannelService.createSqlQuery(UserInfo.class,
                sql2);
        Query  query3 = ebeanQueryChannelService.createSqlQueryMappingColumns(UserInfo.class,
                sql1, columnsMapping);
