...
0	e3		参数ID	227
1	04		参数长度	4
2	0000000b		参数值	[B@309e345f[PositionAttribute[id=18,length=6,bytesValue={0,0,0,0,0,0},value= ], PositionAttribute[id=17,length=1,bytesValue={0},value= ], PositionAttribute[id=227,length=4,bytesValue={0,0,0,11},value= ]]
```
