...
npm run build
```
看这里：如果是刚入门的小伙伴，不知道把项目clone到本地后怎么在本地跑起来，这里写了个详细的说明文档，希望能帮助到你们  [说明文档](http://git.oschina.net/alloyzy/vue2_blog/blob/master/instruction.md)
...
## Github源码
>
[Github源码](https://github.com/alloyteamzy/vue2_blog/)
>
>
