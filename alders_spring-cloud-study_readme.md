...
## 4、Eureka服务发现
  ...
  public Object discovery(){
      ...
      List  instances = discoveryClient.getInstances("STUDY-SPRINGCLOUD-DEPT");
...
- pom文件
  ...
  ```xml
       ...
       springcloud-study-consumer-hystrix-dashboard 
...
- pom文件
  ...
  ```xml
       ...
       springcloud-study-zuul-gateway-9527 
...
- pom文件
  ...
  ```xml
       ...
       springcloud-study-config-client-3355 
