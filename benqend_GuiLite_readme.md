...
- Report build activities to cloud: ![BuildInfo](doc/BuildInfo.png)
- Sync running data to cloud: ![DataOnCloud](doc/data_on_cloud.png)
***
### Support Docker
...
## Thanks and Charity
- Thanks for the help from QQ group, you guys make GuiLite better! And welcome new friend to join us. [ ](https://jq.qq.com/?_wv=1027&k=5EO8D9i)
