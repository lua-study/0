...
- `AbstractData`中的`List  data`属性和相关调用都去掉泛型类型` `
...
-  重要：由于`WordCloud`和`Tree`在2.2.4中才添加的测试，因此修复了一些bug，如果需要这两个新功能，请使用2.2.4版本 
...
- 新增`Treemap`
- 新增对数轴`LogAxis`
-  重要：由于`Venn`和`Treemap`在2.2.4中才添加的测试，因此修复了一些bug，如果需要这两个新功能，请使用2.2.4版本 
