# 备注
修改于官方原版的代码，使得代码可以在ROS Kinect版本上编译通过
编译错误参考链接：https://blog.csdn.net/zhuoyueljl/article/details/78536996?reload
...
本质上来讲主要是作者使用的g2o和PCL版本的问题，我们只需要把ROS中自动安装的版本卸载掉，然后安装作者提供的
g2o和PCL版本即可。

作者提供的代码中有一个 install.sh 脚本文件，通过运行这个文件可以在～/目录下创建一个Code目录，
包含有所有的代码文件，
