...
| --- | --- | --- | --- | --- | --- |
| 6.0.0 | master | ![](https://github.com/Nepxion/Docs/raw/master/discovery-doc/Status1.png) | Hoxton Greenwich Finchley | 2.2.x.RELEASE 2.1.x.RELEASE 2.0.x.RELEASE | 2.2.x.RELEASE 2.1.x.RELEASE 2.0.x.RELEASE |
...
[选择引入] 调用链Opentracing，如需要，请引入
     ...
     com.nepxion 
     discovery-plugin-strategy-starter-service-opentracing 
     ${discovery.version} 
...
[选择引入] 调用链Opentracing，如需要，请引入
     ...
     com.nepxion 
     discovery-plugin-strategy-starter-zuul-opentracing 
     ${discovery.version} 
...
[选择引入] 调用链Opentracing，如需要，请引入
     ...
     com.nepxion 
     discovery-plugin-strategy-starter-gateway-opentracing 
     ${discovery.version} 
...
```xml
          ...
          表示dev区域的消费端，允许访问dev区域的提供端 -->
         
          表示任何区域的消费端，允许访问dev区域和qa区域的提供端 -->
          表示dev区域的消费端，允许访问任何区域的提供端 -->
          表示任何区域的消费端，允许访问任何区域的提供端 -->
