...
|       Model    |  AP val  | AP test     |  AP 50  | Latency GPU  | FPS GPU   | | params | FLOPs |
|----------     |------ |------ |------ | -------- | ------| ------ |------  |  :------: |
...
** AP test  denotes COCO [test-dev2017](http://cocodataset.org/#upload) server results, all other AP results in the table denote val2017 accuracy.  
