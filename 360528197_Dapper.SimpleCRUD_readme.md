...
- Insert (entity) -  Inserts a record and returns the new guid primary key
...
- InsertAsync (entity) -  Inserts a record and returns the new guid primary key
...
```csharp
 public static T Get (this IDbConnection connection, int id)
```
...
```csharp
public static IEnumerable  GetList (this IDbConnection connection)
```
...
```csharp
public static IEnumerable  GetList (this IDbConnection connection, object whereConditions)
```
...
- If you need >   GetList (this IDbConnection connection, string conditions, object parameters = null)
```
...
var user = connection.GetList ("where age = @Age or Name like @Name", new {Age = 10, Name = likename});  
```
Results in 
```sql
...
```csharp
public static IEnumerable  GetListPaged (this IDbConnection connection, int pageNumber, int rowsPerPage, string conditions, string orderby, object parameters = null)
```
...
var user = connection.GetListPaged (1,10,"where age = 10 or Name like '%Smith%'","Name desc");  
```
...
or with parameters
```csharp
var user = connection.GetListPaged (1,10,"where age = @Age","Name desc", new {Age = 10});  
```
Results in (SQL Server dialect)
```sql
...
var newGuid = connection.Insert (new User { FirstName = "User", LastName = "Person",  Age = 10 });  
```
Results in executing this SQL 
```sql
Insert into [Users] (FirstName, LastName, Age) VALUES (@FirstName, @LastName, @Age)
...
```csharp
public static int Delete (this IDbConnection connection, int Id)
```
...
```csharp
public static int Delete (this IDbConnection connection, T entityToDelete)
```
...
```csharp
public static int DeleteList (this IDbConnection connection, object whereConditions, IDbTransaction transaction = null, int? commandTimeout = null)
```

Example usage: 

```csharp     
connection.DeleteList (new { Age = 10 });
```
...
```csharp
public static int DeleteList (this IDbConnection connection, string conditions, object parameters = null, IDbTransaction transaction = null, int? commandTimeout = null)
```

Example usage: 

```csharp     
connection.DeleteList ("Where age > 20");
```
or with parameters
...
```csharp
public static int RecordCount (this IDbConnection connection, string conditions = "", object parameters = null)
```

Example usage: 

```csharp     
var count = connection.RecordCount ("Where age > 20");
```
or with parameters

```csharp     
var count = connection.RecordCount ("Where age > @Age", new {Age = 20});
```
