##### AOS在线演示系统 
[http://42.120.21.17/aos](http://42.120.21.17/aos)  (在线演示系统为只读模式，部分功能可能不流畅。完美体验请搭建本地环境。) 
...
### 环境依赖
Java环境：Java6+ Servlet2.5+。 
数据库：Oracle DB2 PostgreSQL SQL-Server MySQL MariaDB H2。 
应用服务器：Weblogic WebSphere JBoss Tomcat Jetty等 
服务器OS：IBM-AIX HP-Unix Linux系列 Windows。 
