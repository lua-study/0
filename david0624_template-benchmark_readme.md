...
======================
1. Download the source code (`git clone git@gitee.com:jfinal/template-benchmark.git`)
2. Build it (`mvn clean install`)
3. Run the entire benchmark suite with `java -jar target/benchmarks.jar`
4. (Optional) To run a single benchmark, such as Mustache, use `java -jar target/benchmarks.jar Enjoy`
