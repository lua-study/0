...
```
## 4.准备发布包
首先到 [IntelliJ IDEA 官网](https://www.jetbrains.com/idea/download/#section=windows) 下载  IntelliJ IDEA 工具，注意这里要选择  Ultimate 版  。因为只有 Ultimate 版本才拥有Java EE 相关插件以及功能。
...
### 验证服务
通过浏览器地址栏访问接口，请求地址格式 `https://您自己的域名/roomservice/weapp/utils/get_login_info` ，如果没有配置证书，可以用http请求来验证服务。
