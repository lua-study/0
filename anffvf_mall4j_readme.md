...
- mysql    
    `
     ...
     //docker cp /Users/quanxing.yqx/sources/e-mall/mall4j/db/yami_shop.sql mysql:/
     docker cp /root/sources/mall4j/db/yami_shop.sql mysql:/
     ...
     -- 如果你的容器的ip是173.17.0.2，那么你的宿主机ip一定是173.17.0.1
     exit
    `
- redis
    mkdir -p /root/docker/redis/data
    docker run -p 6379:6379 --name redis -v /root/docker/redis/data:/data -d redis redis-server --appendonly yes
