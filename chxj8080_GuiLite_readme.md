...
- Report build activities to cloud: ![BuildInfo](documents/BuildInfo.png)
- Sync running data to cloud: ![DataOnCloud](documents/data_on_cloud.png)
...
- QQ code: [ ](https://jq.qq.com/?_wv=1027&k=5EO8D9i)
