...
下载成功后某些浏览器会弹出保存对话框，请点击`保存`。一般情况，视频文件将会保存到浏览器默认下载文件夹，在浏览器下载列表中也可找到。 
如果你的电脑不能正常播放后缀名为“.ts”格式的视频，可以下载格式转换软件对视频格式进行转换（推荐转换成“mp4”格式）后再进行播放。

  返回顶部  

## 免责声明
下载的视频版权归视频所有者所有，除非视频所有者同意，否则下载的视频仅限作离线播放用途。任何未经授权的剪辑和再发布等行为均为侵犯版权的行为，请尊重创作者的劳动成果。 
本项目作者对下载者本人因使用此工具下载视频后剪辑、再发布等任何侵权行而产生的法律纠纷概不负责。 
请支持正版，本插件**目前暂不支持下载任何非用户自行创作发布的内容（番剧、电影等）**，望谅解。

  返回顶部  

## 联系作者
如果有任何问题请写 [issus](https://github.com/iamscottxu/AcFun-Video-Download/issues) 。 
