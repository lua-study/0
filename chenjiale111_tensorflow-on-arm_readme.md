...
docker run -it -v /tmp/tensorflow_pkg/:/tmp/tensorflow_pkg/ --env TF_PYTHON_VERSION=3.7 tf-arm ./build_tensorflow.sh configs/  # rpi.conf, rk3399.conf ...
```
...
TF_PYTHON_VERSION=3.5 ./build_tensorflow.sh  
